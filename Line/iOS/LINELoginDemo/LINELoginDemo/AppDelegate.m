...
- (void)validateConfigs {
    ...
    BOOL isServerSetupFinished = ![YOUR_VALIDATION_SERVER_DOMAIN isEqualToString:@"<your_line_token_verification_server>"];
    NSAssert(isServerSetupFinished, @"Please set your validation server domain in Constants.h");
}
